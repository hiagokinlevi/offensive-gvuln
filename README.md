...
# Fail CI if any malformed finding record is encountered
python scripts/check_sla.py --findings findings.json --strict

# Limit SLA evaluation to selected severity t
```
